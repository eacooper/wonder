...
box1_ul = [marg 1-marg-text_ht]; %upper left corner of box
[epopup,warn_me,pbox,dpopup] = draw_main_options_box(box1_ul);
...
rradio = uicontrol('Style', 'radiobutton', ...
    ...
    'Position',[marg + text_sz,sz(2) - marg*4,200,text_ht],...
    'Value',    dat.recording);
...
fradio = uicontrol('Style', 'radiobutton', ...
    ...
    'Position',[marg + text_sz,sz(2) - marg*5,200,text_ht],...
    'Value',    dat.training);
...
d1text = uicontrol('Style','text','String','Step Disp (am)',...
    'Position',[marg,sz(2) - marg*7,text_sz,30]);
d1box = uicontrol('Style','edit',...
    'String',dat.dispArcmin,...
    'Position',[marg + text_sz,sz(2) - marg*7,50,31],...
...
d8text = uicontrol('Style','text','String','Speed (deg/sec)',...
    'Position',[marg + 150,sz(2) - marg*7,text_sz,30]);
...
d2text = uicontrol('Style','text','String','Stim Radius (deg)',...
    'Position',[marg + 150,sz(2) - marg*8,text_sz,30]);
...
d3text = uicontrol('Style','text','String','Dot Diam (deg)',...
    'Position',[marg,sz(2) - marg*8,text_sz,30]);
d3box = uicontrol('Style','edit',...
    'String',dat.dotSizeDeg,...
    'Position',[marg + text_sz,sz(2) - marg*8,50,31],...
    'Tag','dotSizeDeg', ...
    'Callback',{@text_Callback});
...
d4text = uicontrol('Style','text','String','Density (d/deg2)',...
    'Position',[marg + 150,sz(2) - marg*9,text_sz,30]);
...
d5text = uicontrol('Style','text','String','Prelude (sec)',...
    'Position',[marg,sz(2) - marg*9,text_sz,30]);
d5box = uicontrol('Style','edit',...
    'String',dat.preludeSec,...
    'Position',[marg + text_sz,sz(2) - marg*9,50,31],...
    'Tag','preludeSec', ...
    'Callback',{@text_Callback});
...
d6text = uicontrol('Style','text','String','Stim (sec) (one ramp)',...
    'Position',[marg + 150,sz(2) - marg*10,text_sz,30]);
...
d7text = uicontrol('Style','text','String','Num repeats',...
    'Position',[marg,sz(2) - marg*10,text_sz,30]);
d7box = uicontrol('Style','edit',...
    'String',dat.cond_repeats,...
    'Position',[marg + text_sz,sz(2) - marg*10,50,31],...
    'Tag','cond_repeats', ...
    'Callback',{@text_Callback});
...
for c = 1:length(conds)
    cradio(c) = uicontrol('Style', 'radiobutton', ...
        ...
        'Position',[sz(1) - marg,sz(2) - marg*(4 + c),200,text_ht],...
...
for d = 1:length(dyn)
    dradio(d) = uicontrol('Style', 'radiobutton', ...
        ...
        'Position',[sz(1) - marg,sz(2) - marg*(11 + d),200,text_ht],...
...
for t = 1:length(dirs)
    ...
    tradio(t) = uicontrol('Style', 'radiobutton', ...
        ...
        'Position',[marg + 90*locx,sz(2) - marg*(11 + locy),100,text_ht],...
...
%  because they are nested at a lower level.
    ...
    function [epopup,warn_me,pbox,dpopup] = draw_main_options_box(box1_ul)
        
        % experiment options
        etext = uicontrol('Style','text','String','Experiment',...
            'Units','normalized', ...
            'Position',[box1_ul(1),box1_ul(2),text_sz,text_ht]);
        
        epopup = uicontrol('Style','popupmenu',...
            'Units','normalized', ...
            'String',{exp(:).name},...
            'Position',[box1_ul(1)+text_sz,box1_ul(2),text_sz*2,text_ht],...
        ...
        warn_me = uicontrol('Style','text','String','All Settings are good',...
            'BackgroundColor',ColorIt(3), ...
            'Units','normalized', ...
            'Position',[box1_ul(1)+text_sz*3,box1_ul(2),text_sz*1.5,text_ht]);
        ...
        stext = uicontrol('Style','text','String','Subject',...
            'Units','normalized', ...
            'Position',[box1_ul(1),box1_ul(2)-text_ht-marg,text_sz,text_ht]);
        
        sbox = uicontrol('Style','edit',...
            'Units','normalized', ...
            'String',subj,...
            'Position',[box1_ul(1)+text_sz,box1_ul(2)-text_ht-marg,text_sz,text_ht],...
        ...
        ptext = uicontrol('Style','text','String','IPD (cm)',...
            'Units','normalized', ...
            'Position',[box1_ul(1)+text_sz*2,box1_ul(2)-text_ht-marg,text_sz,text_ht]);
        
        pbox = uicontrol('Style','edit',...
            'Units','normalized', ...
            'String',ipd,...
            'Position',[box1_ul(1)+text_sz*3,box1_ul(2)-text_ht-marg,text_sz,text_ht],...
        ...
        dtext = uicontrol('Style','text','String','Display',...
            'Units','normalized', ...
            'Position',[box1_ul(1),box1_ul(2)-text_ht*2-marg*2,text_sz,text_ht]);
        dpopup = uicontrol('Style','popupmenu',...
            'Units','normalized', ...
            'String',{dspl(:).name},...
            'Position',[box1_ul(1)+text_sz,box1_ul(2)-text_ht*2-marg*2,text_sz*2,text_ht],...
        ...
        rectangle('Position',[box1_ul(1)-0.01,0.78,0.47,0.215])
